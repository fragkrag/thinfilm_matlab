...
wave_list = (300:0.25:1100)*1e-9;

%edge pass high pass (hp) short pass
hp_layers = 15;
hp_operating_wave = 810e-9;

%edge pass low pass (lp) long pass
lp_layers = 15;
lp_operating_wave = 470e-9;

%cavity (cav)1
cav_layers_top = 6;
cav_layers_bot = 6;
cav_operating_wave = 610e-9;
cav_spacer_index = index_low;
cav_spacers = (200:2.5:1000)*1e-9/2/cav_spacer_index;

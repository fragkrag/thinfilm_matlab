...
index_list_3 = [2, 1.45, 2, 1.45, 2, 1.45, 2, 1.45, 2, 1.45, 2, 1.45, 2, 1.45, 2, 1.45, 2, 1.45, 2, 1.45, 2, 1.45, 2, 1.45, 2];

thick_list_3 = 570e-9./index_list_3/4;
thick_list_3(1) = thick_list_3(1)/2;
thick_list_3(length(thick_list_3)) = thick_list_3(length(thick_list_3))/2;

full_index_list = [index_list_3(:); 1.45; full_index_list(:)];
full_thick_list = [thick_list_3(:); 730e-9/1.45; full_thick_list(:)];
...
% full_index_list = [index_list_3(:)];
% full_thick_list = [thick_list_3(:)];
